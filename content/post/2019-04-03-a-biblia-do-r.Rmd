...
## 3. Funções de configuração e ajuda.
...
Negativo é linguagem ciêntifica (O número dentro não importa).
...
* 2 - digits (Número de digitos que é exibido)
...
Por último mas de muita utilidade, podemos verificar os símbolos operacionais matemático que o **R** utiliza apenas com o comando abaixo.
...
## 2. Estruturas básicas de acesso
